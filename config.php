...
// ----------------------
$options->error_message = 'No result found, try new keyword!';
...
// ------------------------------------
// $options->api_keys = array('TESTKEY');
// Example:
// $options->api_keys[1] = 'demokey';
...
// 'user' (default) - user must pass &xss in searchresults.php querystring to enable
// false - disabled
